...
const blogFields = `title,subtitle,"slug": slug.current, download, downloadLink ,coverImage, 'file': file.asset->url ,date, tags, 'author': author->{name ,'alt': avatar.alt,'avatar': avatar.asset->url}`;
