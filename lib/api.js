...
export const postQuery = groq`title,subtitle,"slug": slug.current, coverImage, 'file': file.asset->url ,date, tags, 'author': author->{name ,'alt': avatar.alt,'avatar': avatar.asset->url},content[]{...,"asset": asset->, markDefs[]{
  		...,
      _type == "internalLink" => {
        "slug": @.reference->slug,       
      }
