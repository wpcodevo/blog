...
const blogFields = ` _id,title,subtitle,"slug": slug.current, download, downloadLink ,coverImage, smallImage,'file': file.asset->url ,date, tags, 'author': author->{name ,'alt': avatar.alt,bio,'avatar': avatar.asset->url}`;
